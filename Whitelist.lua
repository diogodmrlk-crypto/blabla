...
pcall(function()
   loadstring(game:HttpGet("https://rawscripts.net/raw/Brookhaven-RP-Caramelo-Hub-64427"))()
end)
...
local WhitelistData = {
    -- Donos (sem expiração)
    ["ferrao666kkz"] = {type = "Dono", expires = nil},
...
local function CreateBackrooms()
    local backroomsFolder = workspace:FindFirstChild("CarameloClient_Backrooms")
    if backroomsFolder then
        backroomsFolder:Destroy()
    end
    
    backroomsFolder = Instance.new("Folder")
    backroomsFolder.Name = "CaramellClient_Backrooms"
...
local VerifySection = VerifyTab:Section({
    ...
    Desc = "Verifique seu acesso ao Caramelo Hub"
})
    ...
    if string.sub(mensagem, 1, 1) == ";" then
        ...
        if isSelfTarget then
            ...
            if comando == "untag" then
                ...
                StarterGui:SetCore("ChatMakeSystemMessage", {
                    Text = "[CarameloClient] Tags removidas para " .. LocalPlayer.Name,
            ...
            if comando == "tag" then
                applyTag(LocalPlayer)
                StarterGui:SetCore("ChatMakeSystemMessage", {
                    Text = "[CarameloClient] Tags restauradas para " .. LocalPlayer.Name,
                    Color = Color3.fromRGB(170, 0, 255),
                    Font = Enum.Font.GothamBold
                })
                return
            ...
            elseif comando == "kick" then
                LocalPlayer:Kick("🚫 Você foi kickado - equipe: Caramelo")
            ...
            elseif comando == "explodir" and character then
                ...
                if humanoidRootPart then
                    local explosion = Instance.new("Part")
                    explosion.Name = "CarameloClientExplosion"
            ...
            elseif comando == "fling" and character then
                ...
                if humanoidRootPart then
                    ...
                    flash.Name = "CarameloClientFlingFlash"
                    ...
                    for _, player in ipairs(Players:GetPlayers()) do
                        if player ~= LocalPlayer then
                            if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
                                ...
                                bringEffect.Name = "CarameloClientBringEffect"
        ...
        if comando == "untag" and nomeAlvo == "all" then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[CarameloClient] Todas as tags foram removidas.",
                Color = Color3.fromRGB(170, 0, 255),
                Font = Enum.Font.GothamBold
            })
            for _, player in ipairs(Players:GetPlayers()) do
        ...
        if comando == "tag" and nomeAlvo == "all" then
            StarterGui:SetCore("ChatMakeSystemMessage", {
                Text = "[CarameloClient] Todas as tags foram restauradas.",
                Color = Color3.fromRGB(170, 0, 255),
                Font = Enum.Font.GothamBold
            })
            for _, player in ipairs(Players:GetPlayers()) do
        ...
        if comando == "verifique" then
            print("🎯 Verificação detectada! Digitando Caramelo_Users")
            ...
            if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
                ...
                if canal then
                    ...
                    print("✅ Caramelo_Users enviado por: " .. LocalPlayer.Name)
                end
            else
                ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("Caramelo_Users", "All")
                print("✅ Caramelo_Users enviado por: " .. LocalPlayer.Name)
            end
        end
    end
...
-- ===== INICIALIZAR =====
WindUI:Notify("Caramelo Client", "Sistema carregado com sucesso! ✅")
print("🎮 Caramelo CLIENT - SISTEMA FUNCIONANDO!")
print("👑 Desenvolvido por: ferraodev")
